...
q = "CREATE TABLE IF NOT EXISTS RainFall ( Rainfall_MM integer, Year integer , Month integer);"
conn.execute(q)
df = pd.read_csv("/home/amir/Downloads/Rainfall19012016PAK.csv")
df.columns = df.columns.str.strip().to_list()
df.to_sql("RainFall", con=conn, if_exists='replace')
